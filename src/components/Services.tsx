...
const services = [
  {
    ...
    description: "Lightning-fast, custom WordPress websites built for scale and performance.",
    accent: "hover:border-l-blue-500",
  },
  {
    title: "AI Automation",
    category: "Engineering",
    description: "Intelligent workflows and AI agents that put your business operations on autopilot.",
    accent: "hover:border-l-purple-500",
  },
  {
    title: "Meta Marketing",
    category: "Growth",
    description: "Data-driven ad campaigns that maximize ROI and scale your customer acquisition.",
    accent: "hover:border-l-orange-500",
  },
  {
    title: "Social Media Management",
    category: "Marketing",
    description: "Engaging content strategies and community management to grow your brand presence.",
    accent: "hover:border-l-pink-500",
  },
  {
    title: "SME Digitalize",
    category: "Transformation",
    description: "Complete digital transformation solutions tailored for small and medium enterprises.",
    accent: "hover:border-l-yellow-500",
  },
  {
    title: "Post Design",
    category: "Design",
    description: "Eye-catching and professional social media post designs using Canva.",
    accent: "hover:border-l-mint",
  },
];
    ...
    >
      <div className="py-8 px-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-8">
          <span className="hidden md:block text-cream/40 uppercase tracking-widest text-sm font-medium">
            {service.category}
          </span>
          <motion.div
        ...
        {isHovered && (
          ...
          >
            <div className="px-6 pb-8 flex flex-col md:flex-row md:items-center justify-between gap-6">
              <p className="text-xl text-cream/70 max-w-2xl font-light">
                {service.description}
              </p>
              <button className="text-mint font-medium hover-underline self-start md:self-auto">
                Learn More
              </button>
            </div>
          </motion.div>
